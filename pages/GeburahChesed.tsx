        ...
        <header className="mb-8 p-4 border-2 border-[var(--chart-2)] bg-[rgba(0,0,0,0.4)]">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className="text-3xl md:text-4xl font-bold glitch" data-text="GEBURAH // CHESED">
              <span className="text-[var(--chart-1)]">GEBURAH</span>
              <span className="text-[var(--muted-foreground)]"> // </span>
              <span className="text-[var(--chart-4)]">CHESED</span>
            </h1>
            <span className="text-[var(--muted-foreground)]">══╗</span>
          </div>
          <p className="text-[var(--secondary)] text-lg mb-2">גבורה / חסד</p>
          <p className="text-[var(--muted-foreground)] mb-4 typing-effect">Severity & Mercy / The Engine</p>
        ...
        <main className="space-y-6">
          ...
          <div className="p-4 border border-[var(--chart-2)] bg-[rgba(0,0,0,0.3)]">
            <p className="text-[var(--foreground)] leading-relaxed">
              Geburah & Chesed form <span className="text-[var(--secondary)]">The Engine</span>—the dynamic,
              universal mechanism of integration. This stage embodies
              <span className="text-[var(--chart-2)]"> Oscillation over Resolution</span>. Healing and insight
              emerge not from stasis or a final answer, but from the sustained, titrated movement between
              opposing poles. It is the capacity to hold paradox as a path.
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 grid md:grid-cols-2 gap-4">
                <div className="p-3 bg-[rgba(0,0,0,0.3)] border border-[var(--chart-1)]">
                  <h4 className="text-[var(--chart-1)] mb-2">GEBURAH (Severity)</h4>
                  <ul className="space-y-1 text-sm">
                    <li>◆ Sympathetic activation</li>
                    <li>◆ Threat/rigor/contraction</li>
                    <li>◆ High temperature/chaos</li>
                    <li>◆ The critical voice</li>
                  </ul>
                </div>
                <div className="p-3 bg-[rgba(0,0,0,0.3)] border border-[var(--chart-4)]">
                  <h4 className="text-[var(--chart-4)] mb-2">CHESED (Mercy)</h4>
                  <ul className="space-y-1 text-sm">
                    <li>◆ Ventral vagal safety</li>
                    <li>◆ Connection/mercy/expansion</li>
                    <li>◆ Low temperature/coherence</li>
                    <li>◆ The compassionate voice</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="p-3 bg-[rgba(0,0,0,0.3)] border border-[var(--chart-5)]">
                <h4 className="text-[var(--chart-5)] mb-2">CYBORG ISOMORPHISM: MODEL PARAMETERS</h4>
                <p className="text-sm text-[var(--muted-foreground)]">
                  The <code>temperature</code> and <code>top-p</code> settings directly control fluctuation.
                  High temperature (Geburah's fire) introduces chaos and novelty. Low temperature (Chesed's stability)
                  enforces coherence. The user's somatic state is the <em>input</em> that determines optimal settings—
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="p-3 border border-[var(--chart-2)] bg-[rgba(0,0,0,0.2)]">
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    Stephen Porges: Trauma resolution through <em>pendulation</em>—safe, titrated movement
                    between sympathetic activation and ventral vagal safety.
                  </p>
                </div>
