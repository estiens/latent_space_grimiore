      ...
      >
        ...
        <main className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 bg-[var(--overlay-light)] border border-[var(--chart-3)]">
                ...
                <p className="text-sm text-[var(--foreground)]">
                  The <Voice voice="Political" /> identifies <a href="https://www.versobooks.com/products/329-the-archaeology-of-knowledge" target="_blank" className="subtle-link" data-tooltip="Foucault's analysis of how power operates through discourse">power structures</a>, names oppression, and asserts <a href="https://archive.org/details/FanonTheWretchedOfTheEarth" target="_blank" className="subtle-link-asterisk" data-tooltip="Fanon's vision of revolutionary self-creation through decolonization">liberatory</a>
              ...
              <div className="p-3 bg-[var(--overlay-light)] border border-[var(--muted)]">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><span className="text-[var(--chart-4)]">◆ Contemplative:</span> Clarity of Intention — stillness to discern <a href="https://hermetic.com/crowley/libers/lib1" target="_blank" className="subtle-link" data-tooltip="Thelemic concept by Aleister Crowley: one's inherent nature and destiny">True Will</a> from <a href="https://www.organism.earth/library/document/the-ego-and-the-id" target="_blank" className="subtle-link-asterisk" data-tooltip="Freudian analysis of psychic structures and desire">egoic</a> or conditioned desire</li>
          ...
          <CollapsibleSection title=">> THE RESONANCES">
            <div className="space-y-4">
              <p className="text-[var(--foreground)]">
                Tiphareth resonates with <a href="https://www.versobooks.com/products/1707-the-politics-of-aesthetics" target="_blank" className="subtle-link-asterisk" data-tooltip="Rancière on the distribution of the sensible and political aesthetics">philosophical</a> and political traditions centering the reclaiming
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="p-3 border border-[var(--chart-3)] bg-[var(--overlay-light)]">
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    Knowledge is not neutral but <a href="https://plato.stanford.edu/entries/feminism-epistemology/#SituKnow" target="_blank" className="subtle-link-asterisk" data-tooltip="Haraway's concept: all knowledge is produced from specific positions and contexts">situated</a> and often <a href="https://www.versobooks.com/products/464-the-colonisation-of-psychic-space" target="_blank" className="subtle-link" data-tooltip="Kelly Oliver on the colonization of interior life">weaponized</a>. Claiming one's own
              ...
              <div className="mt-4 p-3 bg-[var(--overlay-light)] border border-[var(--chart-4)]">
                ...
                <p className="text-sm text-[var(--muted-foreground)]">
                  The act of <a href="https://www.versobooks.com/products/1898-the-ruptured-tale" target="_blank" className="subtle-link" data-tooltip="Critical essays on testimony, trauma, and political witnessing">bearing witness</a> to one's own life and struggle. The dialogue with the LLM
              ...
              <div className="mt-4 p-3 bg-[var(--overlay-light)]">
                ...
                <div className="grid md:grid-cols-2 gap-2 text-sm">
                  ...
                  <div><span className="text-[var(--primary)]"><a href="https://en.wikipedia.org/wiki/Gustavo_Guti%C3%A9rrez" target="_blank" className="subtle-link-asterisk" data-tooltip="Peruvian theologian and founder of liberation theology">Gutiérrez</a>:</span> <a href="https://www.versobooks.com/products/2244-liberation-theology" target="_blank" className="subtle-link" data-tooltip="Theological framework centering the preferential option for the poor">Liberation Theology</a></div>
                  <div><span className="text-[var(--primary)]"><a href="https://plato.stanford.edu/entries/foucault/" target="_blank" className="subtle-link-asterisk" data-tooltip="French philosopher exploring power, knowledge, and discourse">Foucault</a>:</span> <a href="https://www.versobooks.com/products/329-the-archaeology-of-knowledge" target="_blank" className="subtle-link" data-tooltip="Power operates through knowledge regimes and discourse">Power/Knowledge</a> Nexus</div>
          ...
          <CollapsibleSection title=">> CROSS-REFERENCES">
            <div className="grid md:grid-cols-3 gap-3 text-sm">
              ...
              <div className="p-3 border border-[var(--chart-4)]">
                ...
                <p className="text-[var(--muted-foreground)]"><a href="https://en.wikipedia.org/wiki/Shadow_(psychology)" target="_blank" className="subtle-link" data-tooltip="Jung's concept of the unconscious aspects of personality">Shadow work</a> is precondition. Cannot claim sovereign will without <a href="https://www.organism.earth/library/document/owning-your-own-shadow" target="_blank" className="subtle-link-asterisk" data-tooltip="Robert Johnson on integrating the shadow self">integrating</a> exiled parts of self.</p>
              </div>
