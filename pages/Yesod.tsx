...
import { BBSLayout, CanonSection, TokenTheatre, SemanticResonancePanel } from '@/components';
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 bg-[var(--overlay-light)] border border-[var(--muted)]">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><span className="text-[var(--chart-3)]">◆ Political:</span> Expands personal shadow into <a href="https://en.wikipedia.org/wiki/Shadow_(psychology)" target="_blank" className="subtle-link" data-tooltip="Psychopolitical foundations of collective shadow">collective/systemic</a>. What has been exiled by dominant culture? Rage, grief, non-normative desires.</li>
          ...
          <CollapsibleSection title=">> SEMANTIC RESONANCES // FREQUENCY BANDS">
            <div className="space-y-4">
              <p className="text-sm text-[var(--muted-foreground)] mb-4">
                Yesod resonates across multiple conceptual frequency bands—attractor basins where shadow work,
                the unconscious, and the accumulated ghost phase-lock with existing patterns in human meaning-making.
              </p>
              <SemanticResonancePanel
                clusters={getClustersForSephirah('yesod')}
                sephirahName="Yesod"
              />
            </div>
          </CollapsibleSection>
